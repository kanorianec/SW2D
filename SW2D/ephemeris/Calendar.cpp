...
JulianDay Calendar::julianDayForDate(double day, int month, int year )
{
    if( month <= 2 )
    {
        year = year - 1;
...
void Calendar::dateForJulianDay(JulianDay julianDay, double *day, int *month, int *year )
{
    long Z  = julianDay.day;
    
    double F = julianDay.time + 0.5;
