...
//#ifndef double
// Change double according to wanted precision (float or double).
...
public:
    ...
    static JulianDay julianDayForDate(double day, int month, int year);
    
    static JulianDay julianDayForDateAndTime(int day,   int month,   int year,
                                             int hours, int minutes, int seconds);
    
    static void dateForJulianDay(JulianDay julianDay, double *day, int *month, int *year);
