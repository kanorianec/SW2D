...
int main() {
	...
	double x0 = 0;
	double xN = 2000.0 * (Nx - 1);
	double y0 = 0;
	double yN = 2000.0 * (Ny - 1);
	...
	double mu = 0.0025; // bottom friction coffitient
	...
	string Test_name = "North_Seas_NEMOtide_a03_mu025"; //_noForce";  _OMP_" + to_str(threadsNumber)
